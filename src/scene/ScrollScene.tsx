...
export function ScrollScene({ camaraPanel, cartelPanel }: ScrollSceneProps) {
  ...
  return (
    <div id="inicio" className="relative">
      ...
      {/* data-panel: en celular se pintan recién al acercarse (index.css). */}
      <div data-panel className="relative z-10 bg-ink-950">{camaraPanel}</div>
      <div ref={b} aria-hidden="true" style={{ height: "250vh" }} />
      <div data-panel className="relative z-10 bg-ink-950">{cartelPanel}</div>
